...
# method takes a grid of numbers and returns the largest product of `length` adjacent elements
def largest_product_in_grid(grid_input, length)
...
p largest_product_in_grid(grid, 4) #=> 70600674
